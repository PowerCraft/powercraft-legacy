...
public class PC_EntityFanFX extends EntityFX {
	...
	public void renderParticle(Tessellator tessellator, float tickTime, float rotationX, float rotationXZ, float rotationZ, float rotationYZ, float rotationXY) {
        ...
        GL11.glBindTexture(GL11.GL_TEXTURE_2D, PC_ClientUtils.mc().renderEngine.getTexture(PC_Utils.ModuleInfo.getPowerCraftLoaderImageDir() + "laser.png"));
        ...
        tessellator.addVertexWithUV((double)(x1), (double)(y1), (double)(z1), 1, 0);
        tessellator.addVertexWithUV((double)(x1), (double)(y1), (double)(z1), 1, 1);
