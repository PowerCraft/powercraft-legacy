...
public class PC_Utils {
	...
	public static boolean isBlockReplaceable(World world, int x, int y, int z) {
		...
		if (block instanceof PC_Block) {
			return ((PC_Block) block).isBlockReplaceable(world, x, y, z);
		}
		return false;
	}
	...
	public static void setBlockBounds(Block block, double x, double y, double z, double width, double height, double depht) {
		final int firstID = 184;
		PC_ReflectHelper.setValue(Block.class, block, firstID, x, double.class);
		PC_ReflectHelper.setValue(Block.class, block, firstID + 1, y, double.class);
		PC_ReflectHelper.setValue(Block.class, block, firstID + 2, z, double.class);
		PC_ReflectHelper.setValue(Block.class, block, firstID + 3, width, double.class);
		PC_ReflectHelper.setValue(Block.class, block, firstID + 4, height, double.class);
		PC_ReflectHelper.setValue(Block.class, block, firstID + 5, depht, double.class);
	}
	...
	public static ItemStack getContainerItemStack(ItemStack itemStack) {
		Item i = itemStack.getItem().getContainerItem();
		if (i == null) {
			return null;
		}
