...
public @interface PC_ClientModule {
	 ...
	 * 
	 * @param list
	 *            Function input param: {@link List}<{@link PC_LangRegistry.PC_LangEntry}>
	 ...
	 * 
	 * @param list
	 *            Function input param: {@link List}<{@link String}>
	 ...
	 * 
	 * @param list
	 *            Function input param: {@link List}<{@link PC_Struct2}<{@link Class}< ? extends {@link Entity}>, {@link Render}>>
	 ...
	 * 
	 * @param list
	 *            Function input param: {@link List}<{@link PC_Struct2}<{@link String}, {@link Class}< ? extends {@link PC_IGresClient}>>>
