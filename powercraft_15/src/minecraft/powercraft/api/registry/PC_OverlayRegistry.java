...
public class PC_OverlayRegistry {
	...
	public static void preOverlayRendering(PC_OverlayRenderer baseOverlayRenderer, float timeStamp, boolean screen, int mx, int my) {
	...
	public static void postOverlayRendering(PC_OverlayRenderer baseOverlayRenderer, float timeStamp, boolean screen, int mx, int my) {
		for (PC_IOverlayRenderer overlayRenderer : overlayRenderers) {
