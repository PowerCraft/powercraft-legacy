...
public class PCtr_ItemBlockConveyor extends PC_ItemBlock
{
            ...
            int k, int l, float par8, float par9, float par10)
    {
        ...
        if (world.canPlaceEntityOnSide(getBlockID(), i, j, k, false, l, entityplayer, itemstack))
        {
            Block block = Block.blocksList[getBlockID()];

            if (ValueWriting.setBID(world, i, j, k, getBlockID(), 0));
            {
	...
	public Object msg(int msg, Object... obj) {
		...
		case PC_MSGRegistry.MSG_DEFAULT_NAME:
			...
			names.add(new LangEntry(b.getUnlocalizedName(), (String)b.msg(PC_MSGRegistry.MSG_DEFAULT_NAME)));
			return names;
		}
		return null;
	}
