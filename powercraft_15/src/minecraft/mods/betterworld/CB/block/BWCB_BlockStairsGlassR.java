...
public class BWCB_BlockStairsGlassR extends BlockStairs implements
		ITileEntityProvider {
	...
	public BWCB_BlockStairsGlassR(int par1, Block par2Block, int par3) {
		...
		setUnlocalizedName("BlockStairsGlassR");
