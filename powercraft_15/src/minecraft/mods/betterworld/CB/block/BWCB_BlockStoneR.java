...
public class BWCB_BlockStoneR extends BlockContainer {

	private int damVal;
	private Icon[] iconBuffer;

	public BWCB_BlockStoneR(int id) {

		super(id, Material.rock);
		setStepSound(soundStoneFootstep);
		setUnlocalizedName("BlockStoneResistent");
	...
	public TileEntity createNewTileEntity(World world) {
		return new BWCB_TileEntityBlockStoneR();
	}
	...
	public int getLightValue(IBlockAccess world, int x, int y, int z) {
		...
		if (block == null) {
			...
			return ((BWCB_TileEntityBlockStoneR) world.getBlockTileEntity(x, y,
					z)).getLightValue();
		}
	}
	...
	public Icon getBlockTexture(IBlockAccess par1iBlockAccess, int par2,
		...
		BWCB_TileEntityBlockStoneR tes = (BWCB_TileEntityBlockStoneR) par1iBlockAccess
	...
	public boolean removeBlockByPlayer(World world, EntityPlayer player, int x,
			int y, int z) {
		String userName = ((BWCB_TileEntityBlockStoneR) world
				.getBlockTileEntity(x, y, z)).getUserName();
		boolean lock = ((BWCB_TileEntityBlockStoneR) world.getBlockTileEntity(x,
				y, z)).isBlockLocked();
		...
		if (!world.isRemote
				&& !((EntityPlayerMP) player).theItemInWorldManager
						.isCreative()) {
			int damage = ((BWCB_TileEntityBlockStoneR) world.getBlockTileEntity(
