...
public class BWCB_BlockGlass extends BlockContainer {

	private int damVal;
	private Icon[] iconBuffer;

	public BWCB_BlockGlass(int id) {
	...
	public TileEntity createNewTileEntity(World world) {
		return new BWCB_TileEntityBlockGlass();
	}
	...
	public int getLightValue(IBlockAccess world, int x, int y, int z) {
		...
		if (block == null) {
			...
			return ((BWCB_TileEntityBlockGlass) world.getBlockTileEntity(x, y,
					z)).getLightValue();
		}
	}
	...
	public Icon getBlockTexture(IBlockAccess par1iBlockAccess, int par2,
		...
		BWCB_TileEntityBlockGlass tes = (BWCB_TileEntityBlockGlass) par1iBlockAccess
	...
	public boolean removeBlockByPlayer(World world, EntityPlayer player, int x,
			int y, int z) {
		String userName = ((BWCB_TileEntityBlockGlass) world
				.getBlockTileEntity(x, y, z)).getUserName();
		boolean lock = ((BWCB_TileEntityBlockGlass) world.getBlockTileEntity(x,
				y, z)).isBlockLocked();
		...
		if (!world.isRemote
				&& !((EntityPlayerMP) player).theItemInWorldManager
						.isCreative()) {
			int damage = ((BWCB_TileEntityBlockGlass) world.getBlockTileEntity(
