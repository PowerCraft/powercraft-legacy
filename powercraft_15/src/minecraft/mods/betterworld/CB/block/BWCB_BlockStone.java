...
public class BWCB_BlockStone extends BlockContainer {

	private int damVal;
	private Icon[] iconBuffer;

	public BWCB_BlockStone(int id) {

		super(id, Material.rock);
		setStepSound(soundStoneFootstep);
		setUnlocalizedName("BlockStone");
	...
	public TileEntity createNewTileEntity(World world) {
		return new BWCB_TileEntityBlockStone();
	}
	...
	public int getLightValue(IBlockAccess world, int x, int y, int z) {
		...
		if (block == null) {
			...
			return ((BWCB_TileEntityBlockStone) world.getBlockTileEntity(x, y,
					z)).getLightValue();
		}
	}
	...
	public Icon getBlockTexture(IBlockAccess par1iBlockAccess, int par2,
		...
		BWCB_TileEntityBlockStone tes = (BWCB_TileEntityBlockStone) par1iBlockAccess
	...
	public boolean removeBlockByPlayer(World world, EntityPlayer player, int x,
			int y, int z) {
		String userName = ((BWCB_TileEntityBlockStone) world
				.getBlockTileEntity(x, y, z)).getUserName();
		boolean lock = ((BWCB_TileEntityBlockStone) world.getBlockTileEntity(x,
				y, z)).isBlockLocked();
		...
		if (!world.isRemote
				&& !((EntityPlayerMP) player).theItemInWorldManager
						.isCreative()) {
			int damage = ((BWCB_TileEntityBlockStone) world.getBlockTileEntity(
