...
public class BWCB_BlockWoodR extends BlockContainer {

	private int damVal;
	private Icon[] iconBuffer;

	public BWCB_BlockWoodR(int id) {

		super(id, Material.wood);
		setStepSound(soundWoodFootstep);
		setUnlocalizedName("BlockWoodResistent");
	...
	public TileEntity createNewTileEntity(World world) {
		return new BWCB_TileEntityBlockWoodR();
	}
	...
	public int getLightValue(IBlockAccess world, int x, int y, int z) {
		...
		if (block == null) {
			...
			return ((BWCB_TileEntityBlockWoodR) world
	...
	public Icon getBlockTexture(IBlockAccess par1iBlockAccess, int par2,
		...
		BWCB_TileEntityBlockWoodR tes = (BWCB_TileEntityBlockWoodR) par1iBlockAccess
	...
	public boolean removeBlockByPlayer(World world, EntityPlayer player, int x,
			int y, int z) {
		String userName = ((BWCB_TileEntityBlockWoodR) world.getBlockTileEntity(
				x, y, z)).getUserName();
		boolean lock = ((BWCB_TileEntityBlockWoodR) world.getBlockTileEntity(x,
				y, z)).isBlockLocked();
		...
		if (!world.isRemote
				&& !((EntityPlayerMP) player).theItemInWorldManager
						.isCreative()) {
			int damage = ((BWCB_TileEntityBlockWoodR) world.getBlockTileEntity(
