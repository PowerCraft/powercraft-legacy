...
public class BWCB_ItemBlockStairsWoodR extends ItemBlock {

	public BWCB_ItemBlockStairsWoodR(int id) {
		super(id);
		this.setMaxDamage(0);
		setHasSubtypes(true);
	...
	public void getSubItems(int var1, CreativeTabs var2, List var3) {
		BWCB_BlockStairsWoodR block = (BWCB_BlockStairsWoodR) Block.blocksList[getBlockID()];
