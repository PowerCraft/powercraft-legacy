...
public class BWCB_ItemBlockStoneR extends ItemBlock {

	public BWCB_ItemBlockStoneR(int id) {
		super(id);
		this.setMaxDamage(0);
		setHasSubtypes(true);
		setUnlocalizedName("BlockBricksResistent");
	...
	public boolean placeBlockAt(ItemStack stack, EntityPlayer player,
		...
		if (super.placeBlockAt(stack, player, world, x, y, z, side, hitX, hitY,
				hitZ, metadata)) {
			((BWCB_TileEntityBlockStoneR) world.getBlockTileEntity(x, y, z))
	...
	public void getSubItems(int var1, CreativeTabs var2, List var3) {
		BWCB_BlockStoneR block = (BWCB_BlockStoneR) Block.blocksList[getBlockID()];
