...
public class RecipesCrafting
{
    ...
    public void addRecipes(CraftingManager par1CraftingManager)
    {
        ...
        par1CraftingManager.addRecipe(new ItemStack(Block.field_94347_ck), new Object[] {"#-", '#', Block.chest, '-', Block.tripWireSource});
        ...
        par1CraftingManager.addRecipe(new ItemStack(Block.field_94339_ct, 1, 1), new Object[] {"#", "#", '#', new ItemStack(Block.stoneSingleSlab, 1, 7)});
        par1CraftingManager.addRecipe(new ItemStack(Block.field_94339_ct, 2, 2), new Object[] {"#", "#", '#', new ItemStack(Block.field_94339_ct, 1, 0)});
