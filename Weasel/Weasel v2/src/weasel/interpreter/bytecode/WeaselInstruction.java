...
public abstract class WeaselInstruction {
	...
	private static final Class<? extends WeaselInstruction>[] instructions = new Class[1];
	
	public abstract void run(WeaselInterpreter interpreter, WeaselThread thread, WeaselMethodInfo method);
