...
public class WeaselInstructionSub extends WeaselInstruction {

	private final int primitiveID;
	
	public WeaselInstructionSub(int primitiveID){
		this.primitiveID = primitiveID;
	}
	
	public WeaselInstructionSub(DataInputStream dataInputStream) throws IOException{
