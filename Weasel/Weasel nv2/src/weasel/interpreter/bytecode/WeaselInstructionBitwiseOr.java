...
public class WeaselInstructionBitwiseOr extends WeaselInstruction {

	private final int primitiveID;
	
	public WeaselInstructionBitwiseOr(int primitiveID){
		this.primitiveID = primitiveID;
	}
	
	public WeaselInstructionBitwiseOr(DataInputStream dataInputStream) throws IOException{
	...
	public String toString() {
		return "bitOr "+WeaselPrimitive.primitiveNames[primitiveID];
	}
