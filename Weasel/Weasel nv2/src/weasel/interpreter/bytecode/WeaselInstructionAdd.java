...
public class WeaselInstructionAdd extends WeaselInstruction {

	private final int primitiveID;
	
	public WeaselInstructionAdd(int primitiveID){
		this.primitiveID = primitiveID;
	}
	
	public WeaselInstructionAdd(DataInputStream dataInputStream) throws IOException{
	...
	public String toString() {
		return "add "+WeaselPrimitive.primitiveNames[primitiveID];
	}
