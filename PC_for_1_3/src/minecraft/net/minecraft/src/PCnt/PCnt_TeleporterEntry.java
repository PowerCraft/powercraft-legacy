...
public class PCnt_TeleporterEntry {
	...
	public PCnt_TeleporterEntry(int pi, int pj, int pk) {
		setPos(pi, pj, pk);
	}

	public PCnt_TeleporterEntry(int pi, int pj, int pk, String id) {
		setPos(pi, pj, pk);
		setIdentifier(id);
		setDimension(mc.theWorld.worldInfo.getDimension());
	}

	public PCnt_TeleporterEntry(int pi, int pj, int pk, String id, int dim) {
		setPos(pi, pj, pk);
		setIdentifier(id);
		setDimension(dim);
	}

	public PCnt_TeleporterEntry(String file) {
		load(file);
	}

	public PCnt_TeleporterEntry copy() {
		return new PCnt_TeleporterEntry(i, j, k, identifier);
	}
