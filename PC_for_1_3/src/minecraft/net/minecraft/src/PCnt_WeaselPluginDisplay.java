...
public class PCnt_WeaselPluginDisplay extends PCnt_WeaselPlugin {
	 ...
	 * A display device.
	 */
	public PCnt_WeaselPluginDisplay() {
		super();
	}
	 ...
	 * @param id
	 */
	public PCnt_WeaselPluginDisplay(int id) {
		super(id);
	}
	...
	public boolean onClick(EntityPlayer player) {
		//TODO PC_Utils.openGres(player, new PCnt_GuiWeaselDisplay(this));
		return true;
	}
	...
	@Override
	public int getType() {
		return PCnt_WeaselType.DISPLAY;
	}
