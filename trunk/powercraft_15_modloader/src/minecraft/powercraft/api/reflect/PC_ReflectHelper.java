...
public final class PC_ReflectHelper {
	...
	private static boolean isBetter(Class<?>[] params1, boolean varArg1, Class<?>[] params2, boolean varArg2, Class<?>[] paramsExpect) {
		if (varArg1) {
	...
	public static void setFieldsWithAnnotationTo(Class<?> c, Object obj, Class<? extends Annotation> annotationClass, Object value) {
	...
	public static List<Object> getFieldsWithAnnotation(Class<?> c, Object obj, Class<? extends Annotation> annotationClass) {
	...
	public static <T extends Annotation> List<Field> getAllFieldsWithAnnotation(Class<?> c, Object obj, Class<T> annotationClass,
			PC_IFieldAnnotationIterator<T> iterator) {
		Field fa[] = c.getDeclaredFields();
	...
	public static <T extends Annotation> List<Method> getAllMethodsWithAnnotation(Class<?> c, Object obj, Class<T> annotationClass,
			PC_IMethodAnnotationIterator<T> iterator) {
	...
	public <T extends Annotation> Object callMethodWithAnnotation(Class<?> c, Object obj, Class<T> annotationClass, Object... param) {
		List<Method> methods = getAllMethodsWithAnnotation(c, obj, annotationClass, null);
