...
public class PC_GresProgressBar extends PC_GresWidget {
	 ...
	 * 
	 * @param type
	 *            the bar type (0=striped outset, 1=outset, 2=plain)
	 * @return this
	 */
	 ...
	 *            the label multiplier (if set to 100, percent sign
	 *            will be shown)
	 * @return this
	 */
	 ...
	 *            label unit (eg. %, km, t)
	 * @param longest
	 *            longest expected text shown on label (eg. 100% or 999km)
	 * @param multiplier
	 *            fraction multiplier. The fraction is multiplied by this
