...
public class PC_PacketHandler extends powercraft.launcher.PC_PacketHandler {
	public static final int PACKETTILEENTITY = 0, PACKETPACKETHANDLER = 1,
			PACKETGUI = 2, PACKETIDS = 3, PACKETREQUESTIDLIST=4;
		...
		try {
			...
			default:
				throw new IllegalArgumentException(
						"Neither TE nor PacketHandler nor Gui");
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	protected void handleIncomingTEPacket(ObjectInputStream input,
			EntityPlayer player) throws IOException, ClassNotFoundException {
		int x = input.readInt();
		int y = input.readInt();
		int z = input.readInt();
		PC_Struct2<String, Object>[] o = (PC_Struct2<String, Object>[]) input
				.readObject();
	...
	protected void handleIncomingPacketHandlerPacket(ObjectInputStream input,
			EntityPlayer player) throws IOException, ClassNotFoundException {
	...
	protected void handleIncomingGuiPacket(ObjectInputStream input,
			EntityPlayer player) throws ClassNotFoundException, IOException {
	}

	protected void handleIncomingIDPacket(ObjectInputStream input,
			EntityPlayer player) throws ClassNotFoundException, IOException {
	}

	// AlphaI
	@Deprecated
	public static void setTileEntityArray(TileEntity tileEntity,
			PC_Struct2<String, Object>[] o) {
		setTileEntity(tileEntity, o);
	}

	public static void setTileEntity(TileEntity tileEntity,
			PC_Struct2<String, Object>... o) {
	...
	public static void sendTileEntity(TileEntity tileEntity) {
		if (tileEntity != null) {
			...
			if (world != null) {
				...
				GameInfo.mcs().getConfigurationManager().sendPacketToAllPlayersInDimension(
						tileEntity.getDescriptionPacket(), dimension);
			}
		}
	}
	...
	// AlphaI
	@Deprecated
	public static void sendToPacketHandlerArray(World world, String name,
			Object[] o) {
		sendToPacketHandler(world, name, o);
	}

	public static void sendToPacketHandler(World world, String name,
			Object... o) {
		ByteArrayOutputStream data = new ByteArrayOutputStream();
		ObjectOutputStream sendData;
	...
	// AlphaI
	@Deprecated
	public static void sendToPacketHandlerArray(boolean onlyDimension,
			World world, String name, Object[] o) {
		sendToPacketHandler(onlyDimension, world, name, o);
	}

	public static void sendToPacketHandler(boolean onlyDimension, World world,
	...
	public static void registerPackethandler(String name,
			PC_IPacketHandler packethandler) {
