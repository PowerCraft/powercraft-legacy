...
public class BWCB_ItemBlockStairs extends ItemBlock {

	public BWCB_ItemBlockStairs(int id) {
		super(id);
		this.setMaxDamage(0);
		setHasSubtypes(true);
	...
	public boolean placeBlockAt(ItemStack stack, EntityPlayer player,
		...
		if (super.placeBlockAt(stack, player, world, x, y, z, side, hitX, hitY,
				hitZ, metadata)) {
			((BWCB_TileEntityBlockStairs) world.getBlockTileEntity(x, y, z))
	...
	public void getSubItems(int var1, CreativeTabs var2, List var3) {
		BWCB_BlockStairs block = (BWCB_BlockStairs) Block.blocksList[getBlockID()];
