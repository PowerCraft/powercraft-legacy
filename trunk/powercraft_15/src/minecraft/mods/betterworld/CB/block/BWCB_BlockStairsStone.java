...
public class BWCB_BlockStairsStone extends BlockStairs implements
		ITileEntityProvider {
	...
	public BWCB_BlockStairsStone(int par1, Block par2Block, int par3) {
		...
		setUnlocalizedName("BlockStairsStone");
