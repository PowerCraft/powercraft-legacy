...
public class BWCB_ItemBlockStairsGlassR extends ItemBlock {

	public BWCB_ItemBlockStairsGlassR(int id) {
		super(id);
		this.setMaxDamage(0);
		setHasSubtypes(true);
	...
	public void getSubItems(int var1, CreativeTabs var2, List var3) {
		BWCB_BlockStairsGlassR block = (BWCB_BlockStairsGlassR) Block.blocksList[getBlockID()];
