...
public class BWCB_ItemBlockStairsStone extends ItemBlock {

	public BWCB_ItemBlockStairsStone(int id) {
		super(id);
		this.setMaxDamage(0);
		setHasSubtypes(true);
	...
	public void getSubItems(int var1, CreativeTabs var2, List var3) {
		BWCB_BlockStairsStone block = (BWCB_BlockStairsStone) Block.blocksList[getBlockID()];
