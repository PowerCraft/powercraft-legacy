...
public class BWDeCB_ItemBlockWallStone extends ItemBlock {

	public BWDeCB_ItemBlockWallStone(int id) {
		super(id);
		this.setMaxDamage(0);
		setHasSubtypes(true);
	...
	public boolean placeBlockAt(ItemStack stack, EntityPlayer player,
		...
		if (super.placeBlockAt(stack, player, world, x, y, z, side, hitX, hitY,
				hitZ, metadata)) {
			((BWDeCB_TileEntityBlockWallStone) world.getBlockTileEntity(x, y, z))
	...
	public void getSubItems(int var1, CreativeTabs var2, List var3) {
		BWDeCB_BlockWallStone block = (BWDeCB_BlockWallStone) Block.blocksList[getBlockID()];
