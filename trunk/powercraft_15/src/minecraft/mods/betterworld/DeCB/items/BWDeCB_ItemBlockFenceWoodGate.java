...
public class BWDeCB_ItemBlockFenceWoodGate extends ItemBlock {

	public BWDeCB_ItemBlockFenceWoodGate(int id) {
		super(id);
		this.setMaxDamage(0);
		setHasSubtypes(true);
		setUnlocalizedName("BlockFenceWoodGate");
	...
	public void getSubItems(int var1, CreativeTabs var2, List var3) {
		BWDeCB_BlockFenceWoodGate block = (BWDeCB_BlockFenceWoodGate) Block.blocksList[getBlockID()];
