...
public class PClo_GuiWeaselDiskManager implements PC_IGresBase {
	...
	public void initGui(PC_IGresGui gui) {
		...
		hg1.add(new PC_GresButton(PC_Lang.tr("pc.gui.weasel.diskManager.img.clear")).setButtonPadding(3, 3).setMinWidth(35).setWidgetMargin(1)
				.setId(50));
		hg1.add(new PC_GresButton(PC_Lang.tr("pc.gui.weasel.diskManager.img.fill")).setButtonPadding(3, 3).setMinWidth(35).setWidgetMargin(1)
				.setId(51));
		vg1.add(hg1);
		hg1 = new PC_GresLayoutH().setAlignH(PC_GresAlign.CENTER).setWidgetMargin(0);
		...
		vg1.add(b2 = new PC_GresButton(PC_Lang.tr("pc.gui.weasel.diskManager.formatIntegerList")).setButtonPadding(3, 3).setWidgetMargin(1)
				.setId(102));
