...
public class PCco_GuiCraftingTool implements PC_IGresBase {
	...
	public void initGui(PC_IGresGui gui) {
		...
		//vg.add(buttonSort = (PC_GresButton) new PC_GresButtonImage(mod_PCcore.getImgDir() + "gres/button.png", new PC_CoordI(0,0), new PC_CoordI(17,10)).setButtonPadding(4, 4).setMinWidth(0));
		hg.add(vg);
