 ...
 */
public class PC_Struct8<T1, T2, T3, T4, T5, T6, T7, T8> {
	/**
	 * 1st object
	 */
	public T1 a;
	 ...
	 */
	public PC_Struct8(T1 objA, T2 objB, T3 objC, T4 objD, T5 objE, T6 objF, T7 objG, T8 objH) {
		a = objA;
		b = objB;
		c = objC;
		d = objD;
	...
	public boolean equals(Object obj) {
		...
		return PC_Utils.areObjectsEqual(a, t.a) && PC_Utils.areObjectsEqual(b, t.b) && PC_Utils.areObjectsEqual(c, t.c)
				...
				&& PC_Utils.areObjectsEqual(g, t.g) && PC_Utils.areObjectsEqual(h, t.h);
