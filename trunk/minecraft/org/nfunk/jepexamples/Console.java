 ...
 * mathematical expressions. Usage: java org.nfunk.jepexamples.Console
 * [expression] If an argument is passed, it is interpreted as an expression and
 * evaluated. Otherwise, a prompt is printed, and the user can enter expressions
 * to be evaluated. To exit from the command prompt a 'q' must be entered.
 */
class Console {
