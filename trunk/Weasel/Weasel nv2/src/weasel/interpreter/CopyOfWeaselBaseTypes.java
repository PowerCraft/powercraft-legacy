...
import weasel.interpreter.WeaselPrimitive.WeaselPrimitives;

public class CopyOfWeaselBaseTypes {
	...
	public final WeaselPrimitive[] classes;
	
	public CopyOfWeaselBaseTypes(WeaselInterpreter interpreter){
		this.interpreter = interpreter;
		
		classes = new WeaselPrimitive[WeaselPrimitives.values().length];
		for(int i=0; i<WeaselPrimitives.values().length; i++){
			classes[i] = new WeaselPrimitive(interpreter, i);
		}
	}
...
/*	public void setString(WeaselObject object, String value){
	...
	public void setString(WeaselObject object, String value){
		int size = value.length();
		int array = createArrayObject(size, classes[WeaselPrimitive.CHAR]);
		WeaselObject arrayObject = interpreter.getObject(array);
		for(int i=0; i<size; i++){
			setArrayChar(arrayObject, i, value.charAt(i));
		}
	...
	public void setArrayBoolean(WeaselObject array, int index, boolean value) {
		WeaselChecks.checkArray(array, index, classes[WeaselPrimitives.BOOLEAN.id]);
		array.easyTypes[index+1] = value?-1:0;
	}
	
	public void setArrayChar(WeaselObject array, int index, char value) {
		WeaselChecks.checkArray(array, index, classes[WeaselPrimitives.CHAR.id]);
		array.easyTypes[index+1] = value;
	}
	
	public void setArrayByte(WeaselObject array, int index, byte value) {
		WeaselChecks.checkArray(array, index, classes[WeaselPrimitives.BYTE.id]);
		array.easyTypes[index+1] = value;
	}
	
	public void setArrayShort(WeaselObject array, int index, short value) {
		WeaselChecks.checkArray(array, index, classes[WeaselPrimitives.SHORT.id]);
		array.easyTypes[index+1] = value;
	}
	
	public void setArrayInt(WeaselObject array, int index, int value) {
		WeaselChecks.checkArray(array, index, classes[WeaselPrimitives.INT.id]);
		array.easyTypes[index+1] = value;
	}
	
	public void setArrayLong(WeaselObject array, int index, long value) {
		WeaselChecks.checkArray(array, index, classes[WeaselPrimitives.LONG.id]);
	...
	public void setArrayFloat(WeaselObject array, int index, float value) {
		WeaselChecks.checkArray(array, index, classes[WeaselPrimitives.FLOAT.id]);
	...
	public void setArrayDouble(WeaselObject array, int index, double value) {
		WeaselChecks.checkArray(array, index, classes[WeaselPrimitives.DOUBLE.id]);
	...
	public float getArrayFloat(WeaselObject array, int index) {
		WeaselChecks.checkArray2(array, index, classes[WeaselPrimitives.FLOAT.id]);
		return Float.intBitsToFloat(array.easyTypes[index+1]);
	}
	
	public double getArrayDouble(WeaselObject array, int index) {
		WeaselChecks.checkArray2(array, index, classes[WeaselPrimitives.DOUBLE.id]);
