...
public class WeaselInstructionLShift extends WeaselInstruction {

	private final int primitiveID;
	
	public WeaselInstructionLShift(int primitiveID){
		this.primitiveID = primitiveID;
	}
	
	public WeaselInstructionLShift(DataInputStream dataInputStream) throws IOException{
	...
	public String toString() {
		return "lsh "+WeaselPrimitive.primitiveNames[primitiveID];
	}
