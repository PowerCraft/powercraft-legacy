...
public class WeaselInstructionMod extends WeaselInstruction {

	private final int primitiveID;
	
	public WeaselInstructionMod(int primitiveID){
		this.primitiveID = primitiveID;
	}
	
	public WeaselInstructionMod(DataInputStream dataInputStream) throws IOException{
	...
	public String toString() {
		return "mod "+WeaselPrimitive.primitiveNames[primitiveID];
	}
