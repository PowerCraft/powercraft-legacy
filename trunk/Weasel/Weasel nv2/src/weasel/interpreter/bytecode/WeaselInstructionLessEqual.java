...
public class WeaselInstructionLessEqual extends WeaselInstruction {

	private final int primitiveID;
	
	public WeaselInstructionLessEqual(int primitiveID){
		this.primitiveID = primitiveID;
	}
	
	public WeaselInstructionLessEqual(DataInputStream dataInputStream) throws IOException{
	...
	public String toString() {
		return "lessEqual "+WeaselPrimitive.primitiveNames[primitiveID];
	}
