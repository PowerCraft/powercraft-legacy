...
public class WeaselInstructionNotEqual extends WeaselInstruction {

	private final int primitiveID;
	
	public WeaselInstructionNotEqual(int primitiveID){
		this.primitiveID = primitiveID;
	}
	
	public WeaselInstructionNotEqual(DataInputStream dataInputStream) throws IOException{
		...
		if(primitiveID==0){
			...
			if(o1==null && o2==null){
				...
				if(methodBody.isNative()){
					...
					thread.pushValue(!(Boolean)thread.popValue());
				}
			}else{
	...
	public String toString() {
		return "not equal "+WeaselPrimitive.primitiveNames[primitiveID];
	}
