...
public class WeaselInstructionLess extends WeaselInstruction {

	private final int primitiveID;
	
	public WeaselInstructionLess(int primitiveID){
		this.primitiveID = primitiveID;
	}
	
	public WeaselInstructionLess(DataInputStream dataInputStream) throws IOException{
	...
	public String toString() {
		return "less "+WeaselPrimitive.primitiveNames[primitiveID];
	}
