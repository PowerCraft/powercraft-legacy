...
public class WeaselInstructionGreaterEqual extends WeaselInstruction {

	private final int primitiveID;
	
	public WeaselInstructionGreaterEqual(int primitiveID){
		this.primitiveID = primitiveID;
	}
	
	public WeaselInstructionGreaterEqual(DataInputStream dataInputStream) throws IOException{
	...
	public String toString() {
		return "greaterEqual "+WeaselPrimitive.primitiveNames[primitiveID];
	}
