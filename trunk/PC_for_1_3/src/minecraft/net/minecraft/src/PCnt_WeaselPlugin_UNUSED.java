 ...
 * @copy (c) 2012
 */
public abstract class PCnt_WeaselPlugin_UNUSED extends NetworkMember {
	 ...
	 */
	public PCnt_WeaselPlugin_UNUSED(PCnt_TileEntityWeasel_UNUSED tew) {
		tileEntity = tew;
	}

	/** The tile entity containing this plugin */
	private PCnt_TileEntityWeasel_UNUSED tileEntity;

	public PCnt_TileEntityWeasel_UNUSED getTileEntity(){
		return tileEntity;
	}
	...
	public final void onNeighborBlockChanged() {
		...
		boolean[] inport = PCnt_BlockWeasel_UNUSED.getWeaselInputStates(world(), coord());
	...
	protected final void notifyBlockChange() {
		PCnt_BlockWeasel_UNUSED.hugeUpdate(world(), coord());
	}
	 ...
	 */
	public static PCnt_WeaselPlugin_UNUSED getPluginForType(PCnt_TileEntityWeasel_UNUSED tew, int type) {
	...
	protected final void refreshInport() {
		weaselInport = PCnt_BlockWeasel_UNUSED.getWeaselInputStates(world(), coord());
	}
	...
	@Override
	public final PCnt_WeaselPlugin_UNUSED readFromNBT(NBTTagCompound tag) {
	 ...
	 * @return this
	 */
	protected abstract PCnt_WeaselPlugin_UNUSED readPluginFromNBT(NBTTagCompound tag);
