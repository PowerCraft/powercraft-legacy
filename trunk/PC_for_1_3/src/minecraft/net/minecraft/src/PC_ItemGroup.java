...
public enum PC_ItemGroup {
	PORTABLE, LOGIC, WIRELESS, LOGIC_V, WIRELESS_V, MACHINES, MACHINES_V, OPTICAL, OPTICAL_V,
	...
	FOOD, FOOD_V, COLOURS, COLOURS_V, ORES, ORES_V, ROCKS_ETC, ROCKS_ETC_V, NETWORK, NETWORK_V;
