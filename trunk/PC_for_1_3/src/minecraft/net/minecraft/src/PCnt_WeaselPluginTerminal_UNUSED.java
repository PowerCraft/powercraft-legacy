 ...
 * @author MightyPork
 */
public class PCnt_WeaselPluginTerminal_UNUSED extends PCnt_WeaselPlugin_UNUSED {
	 ...
	 * @param tew
	 */
	public PCnt_WeaselPluginTerminal_UNUSED(PCnt_TileEntityWeasel_UNUSED tew) {
		super(tew);
	}
