    ...
    public boolean matches(InventoryCrafting par1InventoryCrafting, World par2World)
    {
        ...
        for (int var9 = 0; var9 < par1InventoryCrafting.getSizeInventory(); ++var9)
        {
            ...
            if (var10 != null)
            {
                ...
                else if (var10.itemID == Item.field_92106_bV.shiftedIndex)
                {
                    ++var6;
                }
            ...
            if (var4 >= 1 && var3 == 1 && var7 == 0)
            {
                ...
                if (var6 > 0)
                {
                    ...
                    for (int var22 = 0; var22 < par1InventoryCrafting.getSizeInventory(); ++var22)
                    {
                        ...
                        if (var26 != null && var26.itemID == Item.field_92106_bV.shiftedIndex && var26.hasTagCompound() && var26.getTagCompound().hasKey("Explosion"))
                        {
            ...
            else if (var4 == 0 && var3 == 0 && var6 == 1 && var5 > 0 && var5 == var7)
            {
                ...
                for (int var20 = 0; var20 < par1InventoryCrafting.getSizeInventory(); ++var20)
                {
                    ...
                    if (var11 != null)
                    {
                        ...
                        else if (var11.itemID == Item.field_92106_bV.shiftedIndex)
                        {
