...
public class EnchantmentHelper
{
    ...
    public static Map getEnchantments(ItemStack par0ItemStack)
    {
        ...
        NBTTagList var2 = par0ItemStack.itemID == Item.field_92053_bW.shiftedIndex ? Item.field_92053_bW.func_92056_g(par0ItemStack) : par0ItemStack.getEnchantmentTagList();
    ...
    public static void setEnchantments(Map par0Map, ItemStack par1ItemStack)
    {
        ...
        while (var3.hasNext())
        {
            ...
            if (par1ItemStack.itemID == Item.field_92053_bW.shiftedIndex)
            {
    ...
    public static ItemStack addRandomEnchantment(Random par0Random, ItemStack par1ItemStack, int par2)
    {
        ...
        if (var4)
        {
            par1ItemStack.itemID = Item.field_92053_bW.shiftedIndex;
        }
