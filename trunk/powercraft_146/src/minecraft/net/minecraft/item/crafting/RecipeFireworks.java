...
public class RecipeFireworks implements IRecipe
{
    ...
    public boolean matches(InventoryCrafting par1InventoryCrafting, World par2World)
    {
        ...
        for (int var9 = 0; var9 < par1InventoryCrafting.getSizeInventory(); ++var9)
        {
            ...
            if (var10 != null)
            {
                if (var10.itemID == Item.gunpowder.shiftedIndex)
                {
                    ++var4;
                }
                else if (var10.itemID == Item.field_92054_bV.shiftedIndex)
                {
                    ++var6;
                }
                else if (var10.itemID == Item.dyePowder.shiftedIndex)
                {
                    ++var5;
                }
                else if (var10.itemID == Item.paper.shiftedIndex)
                {
                    ++var3;
                }
                else if (var10.itemID == Item.lightStoneDust.shiftedIndex)
                {
                    ++var7;
                }
                else if (var10.itemID == Item.diamond.shiftedIndex)
                {
                    ++var7;
                }
                ...
                else if (var10.itemID == Item.feather.shiftedIndex)
                {
                    ++var8;
                }
                else if (var10.itemID == Item.goldNugget.shiftedIndex)
                {
                    ++var8;
                }
                else
                {
                    if (var10.itemID != Item.skull.shiftedIndex)
                    {
                        return false;
                    }
        ...
        if (var4 <= 3 && var3 <= 1)
        {
            ...
            if (var4 >= 1 && var3 == 1 && var7 == 0)
            {
                ...
                if (var6 > 0)
                {
                    ...
                    for (int var22 = 0; var22 < par1InventoryCrafting.getSizeInventory(); ++var22)
                    {
                        ...
                        if (var26 != null && var26.itemID == Item.field_92054_bV.shiftedIndex && var26.hasTagCompound() && var26.getTagCompound().hasKey("Explosion"))
                        {
            ...
            else if (var4 == 1 && var3 == 0 && var6 == 0 && var5 > 0 && var8 <= 1)
            {
                ...
                for (int var13 = 0; var13 < par1InventoryCrafting.getSizeInventory(); ++var13)
                {
                    ...
                    if (var14 != null)
                    {
                        if (var14.itemID == Item.dyePowder.shiftedIndex)
                        {
                            var12.add(Integer.valueOf(ItemDye.dyeColors[var14.getItemDamage()]));
                        }
                        else if (var14.itemID == Item.lightStoneDust.shiftedIndex)
                        {
                            var18.setBoolean("Flicker", true);
                        }
                        else if (var14.itemID == Item.diamond.shiftedIndex)
                        {
                            var18.setBoolean("Trail", true);
                        }
                        else if (var14.itemID == Item.fireballCharge.shiftedIndex)
                        {
                            var21 = 1;
                        }
                        else if (var14.itemID == Item.feather.shiftedIndex)
                        {
                            var21 = 4;
                        }
                        else if (var14.itemID == Item.goldNugget.shiftedIndex)
                        {
                            var21 = 2;
                        }
                        else if (var14.itemID == Item.skull.shiftedIndex)
                        {
                            var21 = 3;
                        }
                    }
            ...
            else if (var4 == 0 && var3 == 0 && var6 == 1 && var5 > 0 && var5 == var7)
            {
                ...
                for (int var20 = 0; var20 < par1InventoryCrafting.getSizeInventory(); ++var20)
                {
                    ...
                    if (var11 != null)
                    {
                        if (var11.itemID == Item.dyePowder.shiftedIndex)
                        {
                            var16.add(Integer.valueOf(ItemDye.dyeColors[var11.getItemDamage()]));
                        }
                        else if (var11.itemID == Item.field_92054_bV.shiftedIndex)
                        {
