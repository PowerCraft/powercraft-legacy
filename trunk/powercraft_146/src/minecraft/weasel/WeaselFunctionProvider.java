...
public class WeaselFunctionProvider implements IWeaselHardware {
	...
	private HashMap<String, PC_Struct3<PC_Struct2<String , Object>, PC_Struct2<String , Object>, WeaselFunctionProvider>> functions = new HashMap<String, PC_Struct3<PC_Struct2<String , Object>, PC_Struct2<String , Object>, WeaselFunctionProvider>>();
	...
	public WeaselObject call(WeaselEngine engine, String name, boolean var, WeaselObject...args) throws WeaselRuntimeException{
		...
		HashMap<String, PC_Struct3<PC_Struct2<String , Object>, PC_Struct2<String , Object>, WeaselFunctionProvider>> hm = functions;
		for(int i=0; i<subNames.length-1; i++){
			...
			WeaselFunctionProvider fp = hm.get(subNames[i]).c;
			if(fp == null)
				throw new WeaselRuntimeException("Function \""+name+"\" does not exist");
			hm = fp.functions;
		}
	...
	public boolean registerMethod(String name, String realName, Object obj){
		...
		PC_Struct3<PC_Struct2<String , Object>, PC_Struct2<String , Object>, WeaselFunctionProvider> e;
		if(functions.containsKey(subNames[0])){
			e = functions.get(subNames[0]);
		}else{
			functions.put(subNames[0], e = new PC_Struct3<PC_Struct2<String , Object>, PC_Struct2<String , Object>, WeaselFunctionProvider>(null, null, null));
		}
		...
		if(e.c!=null)
			e.c = new WeaselFunctionProvider();
	...
	public List<String> getProvidedFunctionNames() {
		...
		for(Entry<String, PC_Struct3<PC_Struct2<String , Object>, PC_Struct2<String , Object>, WeaselFunctionProvider>> e:functions.entrySet()){
			String key = e.getKey();
