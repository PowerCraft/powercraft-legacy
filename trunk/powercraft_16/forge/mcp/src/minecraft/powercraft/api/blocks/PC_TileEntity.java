...
import powercraft.api.energy.PC_PufferData;
...
public abstract class PC_TileEntity extends TileEntity {
	...
	public void updateEntity(){
		if(!isClient()){
			...
			if(send){
				PC_PacketHandler.sendPacketToAllInDimension(PC_PacketHandler.getBlockDataPacket(worldObj, xCoord, yCoord, zCoord), worldObj.getWorldInfo().getVanillaDimension());
				send = false;
			}
		}
	}
