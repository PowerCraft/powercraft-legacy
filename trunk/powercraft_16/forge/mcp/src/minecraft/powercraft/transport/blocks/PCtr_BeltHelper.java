...
public class PCtr_BeltHelper
{
    ...
    public static boolean isEntityIgnored(Entity entity)
    {
        ...
        if (entity instanceof EntityPlayer)
        {
            ...
            {
                if (((EntityPlayer) entity).inventory.armorItemInSlot(0).itemID == PCtr_ModuleTransport.slimeboots.itemID)
                {
                    return true;
                }
            }
    ...
    public static void packItems(World world, PC_Vec3I pos)
    {
    	if(world.isRemote)
    		return;
    ...
    public static void doSpecialItemAction(World world, PC_Vec3I beltPos, EntityItem entity)
    {
        ...
        boolean flag = false;
        flag |= entity.getEntityItem().itemID == Item.bucketWater.itemID;
        flag |= entity.getEntityItem().itemID == Item.bucketEmpty.itemID;
        flag |= entity.getEntityItem().itemID == Item.glassBottle.itemID;
