    ...
    public ItemStack slotClick(int par1, int par2, int par3, EntityPlayer par4EntityPlayer)
    {
        ...
        if ((par3 == 0 || par3 == 1) && (par2 == 0 || par2 == 1))
        {
            ...
            else
            {
                ...
                {
                    var8 = var7.getStack();
                    ItemStack var12 = var6.getItemStack();
                    ...
                    if (var8 == null)
                    {
                        if (var12 != null && var7.isItemValid(var12))
                        {
                            var9 = par2 == 0 ? var12.stackSize : 1;

                            if (var9 > var7.getSlotStackLimit())
                            {
                                var9 = var7.getSlotStackLimit();
                            }

                            var7.putStack(var12.splitStack(var9));
                    ...
                    else if (var7.canTakeStack(par4EntityPlayer))
                    {
                        if (var12 == null)
                        {
                            var9 = par2 == 0 ? var8.stackSize : (var8.stackSize + 1) / 2;
                            var10 = var7.decrStackSize(var9);
                            var6.setItemStack(var10);
                        ...
                        else if (var7.isItemValid(var12))
                        {
                            if (var8.itemID == var12.itemID && var8.getItemDamage() == var12.getItemDamage() && ItemStack.areItemStackTagsEqual(var8, var12))
                            {
                                var9 = par2 == 0 ? var12.stackSize : 1;

                                if (var9 > var7.getSlotStackLimit() - var8.stackSize)
                                {
                                    var9 = var7.getSlotStackLimit() - var8.stackSize;
                                }

                                if (var9 > var12.getMaxStackSize() - var8.stackSize)
                                {
                                    var9 = var12.getMaxStackSize() - var8.stackSize;
                                }

                                var12.splitStack(var9);
                            ...
                            else if (var12.stackSize <= var7.getSlotStackLimit())
                            {
                                var7.putStack(var12);
                        ...
                        else if (var8.itemID == var12.itemID && var12.getMaxStackSize() > 1 && (!var8.getHasSubtypes() || var8.getItemDamage() == var12.getItemDamage()) && ItemStack.areItemStackTagsEqual(var8, var12))
                        {
                            ...
                            if (var9 > 0 && var9 + var12.stackSize <= var12.getMaxStackSize())
                            {
                                var12.stackSize += var9;
                                var8 = var7.decrStackSize(var9);
        ...
        else if (par3 == 2 && par2 >= 0 && par2 < 9)
        {
            ...
            if (var7.canTakeStack(par4EntityPlayer))
            {
                ...
                boolean var11 = var8 == null || var7.inventory == var6 && var7.isItemValid(var8);
                var9 = -1;

                if (!var11)
                {
                    var9 = var6.getFirstEmptyStack();
                    var11 |= var9 > -1;
                }

                if (var7.getHasStack() && var11)
                {
                    var10 = var7.getStack();
                    var6.setInventorySlotContents(par2, var10);
                    ...
                    if ((var7.inventory != var6 || !var7.isItemValid(var8)) && var8 != null)
                    {
                        if (var9 > -1)
                        {
                            ...
                            var7.decrStackSize(var10.stackSize);
                            var7.putStack((ItemStack)null);
                            var7.onPickupFromSlot(par4EntityPlayer, var10);
                        }
                    }
                    else
                    {
    ...
    protected boolean mergeItemStack(ItemStack par1ItemStack, int par2, int par3, boolean par4)
    {
        ...
        if (par1ItemStack.isStackable())
        {
            while (par1ItemStack.stackSize > 0 && (!par4 && var6 < par3 || par4 && var6 >= par2))
            {
                ...
                var8 = var7.getStack();
                var9 = Math.min(var7.getSlotStackLimit(), par1ItemStack.getMaxStackSize());

                if (var8 != null && var7.isItemValid(par1ItemStack) && var8.itemID == par1ItemStack.itemID && (!par1ItemStack.getHasSubtypes() || par1ItemStack.getItemDamage() == var8.getItemDamage()) && ItemStack.areItemStackTagsEqual(par1ItemStack, var8))
                {
                    int var10 = var8.stackSize + par1ItemStack.stackSize;
                    ...
                    {
                        par1ItemStack.stackSize -= var9 - var8.stackSize;
                        var8.stackSize = var9;
                        var7.onSlotChanged();
                        var5 = true;
                    }
        ...
        if (par1ItemStack.stackSize > 0)
        {
            ...
            while (!par4 && var6 < par3 || par4 && var6 >= par2)
            {
                ...
                {
                    var8 = par1ItemStack.copy();
                    var7.putStack(var8);

                    if (par1ItemStack.stackSize > var9)
                    {
                        par1ItemStack.stackSize -= var9;
                        var8.stackSize = var9;
                    }
                    else
                    {
