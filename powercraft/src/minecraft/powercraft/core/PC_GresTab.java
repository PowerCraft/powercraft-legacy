...
public class PC_GresTab extends PC_GresWidget {
	...
	private void renderButton(PC_CoordI posOffset, boolean left){
		...
		renderTextureSliced(posOffset, imgdir + "gres/button.png", new PC_CoordI(10, 12), new PC_CoordI(0, state * 50), new PC_CoordI(256, 50));

		// and here goes the image
		GL11.glBindTexture(GL11.GL_TEXTURE_2D, mc.renderEngine.getTexture(imgdir + "gres/widgets.png"));
