...
public class PCma_TileEntityAutomaticWorkbench extends PC_TileEntity implements IInventory, PC_IStateReportingInventory, PC_ISpecialAccessInventory {
	...
	public ItemStack getStorageProduct() {
		ItemStack product = CraftingManager.getInstance().func_82787_a(getStorageAsCraftingGrid(null), worldObj);
		if (product != null) {
			return product.copy();
		}
		return null;
	...
	public ItemStack getRecipeProduct() {
		ItemStack product = CraftingManager.getInstance().func_82787_a(getRecipeAsCraftingGrid(null), worldObj);
		if (product != null) {
			return product.copy();
		}
		return null;
