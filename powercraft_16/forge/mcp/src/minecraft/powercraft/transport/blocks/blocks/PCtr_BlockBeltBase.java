...
public abstract class PCtr_BlockBeltBase extends PC_BlockWithoutTileEntity
{
	private boolean isElevator = false;

	public PCtr_BlockBeltBase(int id, Material material, boolean b_isElevator)
	{
		super(id, material);
		isElevator = b_isElevator;
		if (isElevator)
			setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, PCtr_BeltHelper.ELEVATOR_HEIGHT, 1.0F);
		else
