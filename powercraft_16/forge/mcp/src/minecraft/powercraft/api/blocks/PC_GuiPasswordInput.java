...
class PC_GuiPasswordInput implements PC_IGresGui, PC_IGresEventListener {
	...
	protected PC_GuiPasswordInput(PC_TileEntity tileEntity) {
	...
	private void send(){
		tileEntity.setPassword(password.getText());
		status.setText("Sending ...");
		ok.setEnabled(false);
		PC_PacketHandler.sendPacketToServer(tileEntity.getReactivatePackage());
	}
